 ...
 */
public class Cadastro_Orcamento extends javax.swing.JFrame {
   ...
   int navega = 0;
    ...
    public Cadastro_Orcamento() {
        ...
        try {
            ...
            Logger.getLogger(Cadastro_Orcamento.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
    ...
    */
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(new Runnable() {
            @Override
            public void run() {
                new Cadastro_Orcamento().setVisible(true);
            }
        });
    }
