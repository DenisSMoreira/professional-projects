...
public class SendMailAcc {
	 ...
	 */
	SendMailAcc(String mailSMTPServer, String mailSMTPServerPort) { //Para outro Servidor
	...
	public void sendMail(String from, String to, String subject, String message) {
		...
		auth = new SimpleAuth ("denis.soares.moreira@gmail.com","zvc6ve64");
		...
		try {
			 ...
			 */
			tr.connect(mailSMTPServer, "denis.soares.moreira@gmail.com","zvc6ve64");
