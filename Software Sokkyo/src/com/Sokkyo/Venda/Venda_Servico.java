 ...
 */
public class Venda_Servico extends javax.swing.JFrame {
 Conexão software_Sokkyo;
    /** Creates new form Venda_Servico */
...
software_Sokkyo.executeSQL("select * from cadastro_fornecedor");
 ...
 datae.setText(""+data.getDate()+"/"+data.getMonth()+"/"+(data.getYear()-100));
    ...
    private void initComponents() {
        ...
        vscodigoser1.setFont(new java.awt.Font("Tahoma", 1, 11));
        ...
        jLabel39.setFont(new java.awt.Font("Arial Black", 1, 14));
        ...
        descrição.setFont(new java.awt.Font("Tahoma", 1, 11));
        descrição.setRows(5);
    ...
    */
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(new Runnable() {
            @Override
            public void run() {
                new Venda_Servico().setVisible(true);
            }
        });
    }
